...
Wrapper around Win32 API functions for managing (Group) Managed Service Accounts. Creator https://github.com/beatcracker/Powershell-Misc/blob/master/Use-ServiceAccount.ps1
