...
Add-DhcpServerV4Scope -Name "DHCP Scope" -StartRange 10.10.0.0 -EndRange 10.10.0.250 -SubnetMask 255.255.255.0 -State Active
Add-DhcpServerInDC -DNSName "$($ComputerName).earth.lo" -IPAddress $IP_SRV
