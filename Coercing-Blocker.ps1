...
New-GPO -Name "[Firewall](GPO,Computer) Default rules for DC" | %{
	...
	New-NetFirewallRule -Enabled True -Profile Any -ErrorAction Continue -GPOSession $GpoSessionName -DisplayName "[GPO] Allow * for DC" -Action Allow -Inbound Outbound -RemoteAddress @('192.168.1.1','192.168.1.2') >$null
